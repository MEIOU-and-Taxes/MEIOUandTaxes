...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 25), ('Strait of Gibraltar', 25), ('Gulf of Lion', 25), ('France', 23), ('Channel', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 23), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 28), ('Lake Tchad', 28), ('Kongo', 28),
     ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 31), ('Caribbean', 30), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 29), ('Great Lakes', 29),
     ('American West Coast', 33), ('Pacific', 43)])
# Northern Europe
expeditions_list.append(Expedition('northern_europe', 'Northern Europe', 0, 'Jumping Node', [85]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 25), ('Strait of Gibraltar', 25), ('Gulf of Lion', 25), ('France', 23), ('Channel', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 23), ('Eastern Baltic', 23), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 28), ('Lake Tchad', 28), ('Kongo', 28),
     ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 31), ('Caribbean', 30), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 29), ('Great Lakes', 29),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 25), ('Gulf of Lion', 25), ('France', 23), ('Channel', 23), ('Western Baltic', 23), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 23), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 23), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 28), ('Lake Tchad', 28), ('Kongo', 28),
     ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Gulf of Lion', 25), ('France', 25), ('Channel', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 25), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 26), ('Upper Niger', 26),
     ('Guinea Coast', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 29), ('Great Lakes', 29),
     ('American West Coast', 33), ('Pacific', 43)])
# the Iberian Islands
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Gulf of Lion', 25), ('France', 25), ('Channel', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 25), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 26), ('Upper Niger', 26),
     ('Guinea Coast', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 30), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 29), ('Great Lakes', 29),
     ('American West Coast', 33), ('Pacific', 43)])
# Northwest Africa
expeditions_list.append(Expedition('northwest_africa', 'Northwest Africa', 100, 'Jumping Node', [70]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 23), ('Strait of Gibraltar', 23), ('Gulf of Lion', 25), ('France', 25), ('Channel', 25), ('Western Baltic', 25), ('Berber Coast', 25), ('Tyrrenean Sea', 25), ('Rhineland', 25), ('Lower Nile', 25), ('Po Valley', 25), ('Adriatic Sea', 25), ('Levantine Sea', 25), ('Aegean Sea', 25),
     ('Lower Danube', 25), ('Middle Danube', 25), ('Elbe', 25), ('Eastern Baltic', 25), ('Vistula', 25), ('Black Sea', 25), ('Western Siberia', 25), ('Dnipro', 25), ('Volga', 25), ('Caspian Sea', 25), ('Zalesye', 25), ('Caucasus', 25), ('Sahara', 25), ('Senegambia', 26), ('Upper Niger', 26), ('Guinea Coast', 27), ('Lake Tchad', 27), ('Kongo', 28),
     ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 32), ('Abyssinian Highlands', 32), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 29), ('Great Lakes', 29),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 26), ('Strait of Gibraltar', 26), ('Sahara', 26), ('Gulf of Lion', 27), ('France', 27), ('Channel', 27), ('Western Baltic', 27), ('Berber Coast', 27), ('Tyrrenean Sea', 27), ('Rhineland', 27), ('Lower Nile', 27), ('Po Valley', 27), ('Adriatic Sea', 27), ('Levantine Sea', 27),
     ('Aegean Sea', 27), ('Lower Danube', 27), ('Middle Danube', 27), ('Elbe', 27), ('Eastern Baltic', 27), ('Vistula', 27), ('Black Sea', 27), ('Western Siberia', 27), ('Dnipro', 27), ('Volga', 27), ('Caspian Sea', 27), ('Zalesye', 27), ('Caucasus', 27), ('Senegambia', 23), ('Upper Niger', 23), ('Guinea Coast', 23), ('Lake Tchad', 23), ('Kongo', 25),
     ('South Africa', 27), ('Monomotapa', 28), ('Zanj', 28), ('Red Sea', 30), ('Abyssinian Highlands', 30), ('Jazira', 30), ('Arabian Gulf', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Tarim Basin', 30),
     ('Punjab', 30), ('Gurjaratra', 30), ('Konkan', 30), ('Southern Deccan', 30), ('Tamilakam', 30), ('Kalinga', 30), ('Doab', 30), ('Bihar', 32), ('Bengal', 30), ('Tibetan Plateau', 30), ('Yunnan', 30), ('Lower Ayeyarwady', 31), ('Malacca Strait', 31), ('Mekong', 31), ('Sunda Strait', 31),
     ('Champa Sea', 31), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 31), ('Southern Cone', 30), ('Guiana', 27), ('Amazonia', 31), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 31), ('Great Lakes', 31),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 27), ('Strait of Gibraltar', 27), ('Sahara', 26), ('Gulf of Lion', 28), ('France', 28), ('Channel', 28), ('Western Baltic', 28), ('Berber Coast', 28), ('Tyrrenean Sea', 28), ('Rhineland', 28), ('Lower Nile', 28), ('Po Valley', 28), ('Adriatic Sea', 28), ('Levantine Sea', 28),
     ('Aegean Sea', 28), ('Lower Danube', 28), ('Middle Danube', 28), ('Elbe', 28), ('Eastern Baltic', 28), ('Vistula', 28), ('Black Sea', 28), ('Western Siberia', 28), ('Dnipro', 28), ('Volga', 28), ('Caspian Sea', 28), ('Zalesye', 28), ('Caucasus', 28), ('Senegambia', 23), ('Upper Niger', 23), ('Guinea Coast', 23), ('Lake Tchad', 23), ('Kongo', 23),
     ('South Africa', 27), ('Monomotapa', 27), ('Zanj', 27), ('Red Sea', 30), ('Abyssinian Highlands', 30), ('Jazira', 31), ('Arabian Gulf', 31), ('Iran', 31), ('Khorasan', 31), ('Mawarannahr', 31), ('Tarim Basin', 31),
     ('Punjab', 31), ('Gurjaratra', 31), ('Konkan', 31), ('Southern Deccan', 31), ('Tamilakam', 31), ('Kalinga', 31), ('Doab', 31), ('Bihar', 31), ('Bengal', 31), ('Tibetan Plateau', 31), ('Yunnan', 31), ('Lower Ayeyarwady', 31), ('Malacca Strait', 31), ('Mekong', 31), ('Sunda Strait', 31),
     ('Champa Sea', 31), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 31), ('Southern Cone', 30), ('Guiana', 27), ('Amazonia', 31), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 31), ('Great Lakes', 31),
     ('American West Coast', 32), ('Pacific', 43)])
...
expeditions_list[-1].set_node_tech_reqs([('Iberia', 28), ('Strait of Gibraltar', 28), ('Sahara', 27), ('Gulf of Lion', 29), ('France', 29),
                                         ('Channel', 29), ('Western Baltic', 29), ('Berber Coast', 29), ('Tyrrenean Sea', 29), ('Rhineland', 29), ('Lower Nile', 29), ('Po Valley', 29), ('Adriatic Sea', 29), ('Levantine Sea', 29), ('Aegean Sea', 29), ('Lower Danube', 29), ('Middle Danube', 29), ('Elbe', 29), ('Eastern Baltic', 29),
                                         ('Vistula', 29), ('Black Sea', 29), ('Western Siberia', 29), ('Dnipro', 29), ('Volga', 29), ('Caspian Sea', 29), ('Zalesye', 29), ('Caucasus', 29), ('Senegambia', 25), ('Upper Niger', 23), ('Guinea Coast', 23), ('Lake Tchad', 23), ('Kongo', 23), ('South Africa', 25), ('Monomotapa', 27),
                                         ('Zanj', 27), ('Red Sea', 29), ('Abyssinian Highlands', 29), ('Jazira', 30), ('Arabian Gulf', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Tarim Basin', 30),
                                         ('Punjab', 30), ('Gurjaratra', 30), ('Konkan', 30), ('Southern Deccan', 30), ('Tamilakam', 30), ('Kalinga', 30), ('Doab', 30), ('Bihar', 30), ('Bengal', 30), ('Tibetan Plateau', 30), ('Yunnan', 30), ('Lower Ayeyarwady', 30), ('Malacca Strait', 30),
                                         ('Mekong', 30), ('Sunda Strait', 30),
                                         ('Champa Sea', 30), ('Australia', 31), ('Liangguang', 31), ('Szechwan', 31), ('Huazhong', 31), ('Jiangxi', 31), ('Jiangnan', 31), ('Huabei', 31), ('Xibei', 31), ('Zhongyuan', 31), ('Eastern Siberia', 31), ('Nippon', 31),
                                         ('Amur', 31), ('Chala', 31), ('Southern Cone', 30), ('Guiana', 28), ('Amazonia', 31), ('Panama', 31), ('Caribbean', 29), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 31), ('Great Lakes', 31),
                                         ('American West Coast', 32), ('Pacific', 43)])
# South Africa
expeditions_list.append(Expedition('south_africa', 'South Africa', 1200, 'Colonial Node', [44]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 28), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 27), ('Lake Tchad', 27), ('Kongo', 25), ('South Africa', 23), ('Monomotapa', 25), ('Zanj', 25), ('Red Sea', 26),
     ('Abyssinian Highlands', 26), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 28), ('Konkan', 28), ('Southern Deccan', 28), ('Tamilakam', 28), ('Kalinga', 28), ('Doab', 28), ('Bihar', 28), ('Bengal', 28), ('Tibetan Plateau', 28), ('Yunnan', 28), ('Lower Ayeyarwady', 30), ('Malacca Strait', 30), ('Mekong', 30), ('Sunda Strait', 30),
     ('Champa Sea', 30), ('Australia', 31), ('Liangguang', 30), ('Szechwan', 30), ('Huazhong', 30), ('Jiangxi', 30), ('Jiangnan', 30), ('Huabei', 30), ('Xibei', 30), ('Zhongyuan', 31), ('Eastern Siberia', 31), ('Nippon', 31),
     ('Amur', 31), ('Chala', 31), ('Southern Cone', 30), ('Guiana', 29), ('Amazonia', 31), ('Panama', 31), ('Caribbean', 30), ('Valley of Mexico', 31), ('Rio Grande', 31), ('Mississippi', 31), ('Plains', 31), ('Eastern Seaboard', 31), ('Great Lakes', 31),
     ('American West Coast', 32), ('Pacific', 43)])
# East Africa
expeditions_list.append(Expedition('east_africa', 'East Africa', 800, 'Jumping Node', [43]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 28), ('Upper Niger', 28), ('Guinea Coast', 27), ('Lake Tchad', 28), ('Kongo', 27), ('South Africa', 25), ('Monomotapa', 23), ('Zanj', 23), ('Red Sea', 23),
     ('Abyssinian Highlands', 23), ('Jazira', 25), ('Arabian Gulf', 25), ('Iran', 26), ('Khorasan', 26), ('Mawarannahr', 26), ('Tarim Basin', 26),
     ('Punjab', 26), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 27), ('Kalinga', 27), ('Doab', 27), ('Bihar', 27), ('Bengal', 27), ('Tibetan Plateau', 27), ('Yunnan', 27), ('Lower Ayeyarwady', 29), ('Malacca Strait', 29), ('Mekong', 30), ('Sunda Strait', 30),
     ('Champa Sea', 30), ('Australia', 31), ('Liangguang', 30), ('Szechwan', 30), ('Huazhong', 30), ('Jiangxi', 30), ('Jiangnan', 30), ('Huabei', 30), ('Xibei', 30), ('Zhongyuan', 31), ('Eastern Siberia', 31), ('Nippon', 31),
     ('Amur', 31), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 32), ('Caribbean', 31), ('Valley of Mexico', 32), ('Rio Grande', 32), ('Mississippi', 32), ('Plains', 32), ('Eastern Seaboard', 32), ('Great Lakes', 32),
     ('American West Coast', 33), ('Pacific', 43)])
# the Indian Ocean
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 28), ('Upper Niger', 28), ('Guinea Coast', 27), ('Lake Tchad', 28), ('Kongo', 27), ('South Africa', 25), ('Monomotapa', 23), ('Zanj', 23), ('Red Sea', 25),
     ('Abyssinian Highlands', 25), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 27), ('Kalinga', 27), ('Doab', 27), ('Bihar', 27), ('Bengal', 27), ('Tibetan Plateau', 27), ('Yunnan', 27), ('Lower Ayeyarwady', 29), ('Malacca Strait', 29), ('Mekong', 30), ('Sunda Strait', 30),
     ('Champa Sea', 30), ('Australia', 31), ('Liangguang', 30), ('Szechwan', 30), ('Huazhong', 30), ('Jiangxi', 30), ('Jiangnan', 30), ('Huabei', 30), ('Xibei', 30), ('Zhongyuan', 31), ('Eastern Siberia', 31), ('Nippon', 31),
     ('Amur', 31), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 32), ('Caribbean', 31), ('Valley of Mexico', 32), ('Rio Grande', 32), ('Mississippi', 32), ('Plains', 32), ('Eastern Seaboard', 32), ('Great Lakes', 32),
     ('American West Coast', 33), ('Pacific', 43)])
# Arabian Gulf
expeditions_list.append(Expedition('Arabian Gulf', 'Arabian Gulf', 400, 'Jumping Node', [41, 40]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 26), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 27), ('Monomotapa', 26), ('Zanj', 25), ('Red Sea', 23),
     ('Abyssinian Highlands', 23), ('Jazira', 23), ('Arabian Gulf', 23), ('Iran', 23), ('Khorasan', 23), ('Mawarannahr', 23), ('Tarim Basin', 23),
     ('Punjab', 23), ('Gurjaratra', 25), ('Konkan', 25), ('Southern Deccan', 25), ('Tamilakam', 25), ('Kalinga', 25), ('Doab', 25), ('Bihar', 25), ('Bengal', 25), ('Tibetan Plateau', 25), ('Yunnan', 25), ('Lower Ayeyarwady', 27), ('Malacca Strait', 27), ('Mekong', 27), ('Sunda Strait', 27),
     ('Champa Sea', 27), ('Australia', 29), ('Liangguang', 29), ('Szechwan', 29), ('Huazhong', 29), ('Jiangxi', 29), ('Jiangnan', 29), ('Huabei', 29), ('Xibei', 29), ('Zhongyuan', 30), ('Eastern Siberia', 30), ('Nippon', 30),
     ('Amur', 30), ('Chala', 32), ('Southern Cone', 31), ('Guiana', 30), ('Amazonia', 32), ('Panama', 32), ('Caribbean', 31), ('Valley of Mexico', 32), ('Rio Grande', 32), ('Mississippi', 32), ('Plains', 32), ('Eastern Seaboard', 32), ('Great Lakes', 32),
     ('American West Coast', 33), ('Pacific', 43)])
# Western India
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Monomotapa', 27), ('Zanj', 27), ('Red Sea', 25),
     ('Abyssinian Highlands', 25), ('Jazira', 23), ('Arabian Gulf', 23), ('Iran', 25), ('Khorasan', 25), ('Mawarannahr', 23), ('Tarim Basin', 23),
     ('Punjab', 23), ('Gurjaratra', 23), ('Konkan', 23), ('Southern Deccan', 23), ('Tamilakam', 23), ('Kalinga', 25), ('Doab', 23), ('Bihar', 23), ('Bengal', 25), ('Tibetan Plateau', 25), ('Yunnan', 25), ('Lower Ayeyarwady', 27), ('Malacca Strait', 27), ('Mekong', 27), ('Sunda Strait', 27),
     ('Champa Sea', 27), ('Australia', 28), ('Liangguang', 28), ('Szechwan', 28), ('Huazhong', 28), ('Jiangxi', 28), ('Jiangnan', 28), ('Huabei', 28), ('Xibei', 28), ('Zhongyuan', 29), ('Eastern Siberia', 29), ('Nippon', 29),
     ('Amur', 29), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Southern India
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Monomotapa', 27), ('Zanj', 27), ('Red Sea', 25),
     ('Abyssinian Highlands', 25), ('Jazira', 25), ('Arabian Gulf', 25), ('Iran', 25), ('Khorasan', 25), ('Mawarannahr', 25), ('Tarim Basin', 25),
     ('Punjab', 25), ('Gurjaratra', 23), ('Konkan', 23), ('Southern Deccan', 23), ('Tamilakam', 23), ('Kalinga', 23), ('Doab', 23), ('Bihar', 23), ('Bengal', 25), ('Tibetan Plateau', 25), ('Yunnan', 25), ('Lower Ayeyarwady', 25), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 26), ('Australia', 28), ('Liangguang', 28), ('Szechwan', 28), ('Huazhong', 28), ('Jiangxi', 28), ('Jiangnan', 28), ('Huabei', 28), ('Xibei', 28), ('Zhongyuan', 29), ('Eastern Siberia', 29), ('Nippon', 29),
     ('Amur', 29), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Eastern India
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 28), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 28), ('Monomotapa', 27), ('Zanj', 27), ('Red Sea', 26),
     ('Abyssinian Highlands', 26), ('Jazira', 25), ('Arabian Gulf', 25), ('Iran', 25), ('Khorasan', 25), ('Mawarannahr', 25), ('Tarim Basin', 25),
     ('Punjab', 25), ('Gurjaratra', 25), ('Konkan', 25), ('Southern Deccan', 25), ('Tamilakam', 23), ('Kalinga', 23), ('Doab', 23), ('Bihar', 23), ('Bengal', 23), ('Tibetan Plateau', 23), ('Yunnan', 23), ('Lower Ayeyarwady', 25), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 26), ('Australia', 27), ('Liangguang', 26), ('Szechwan', 26), ('Huazhong', 27), ('Jiangxi', 27), ('Jiangnan', 27), ('Huabei', 27), ('Xibei', 27), ('Zhongyuan', 27), ('Eastern Siberia', 28), ('Nippon', 28),
     ('Amur', 28), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Malacca
expeditions_list.append(Expedition('malacca', 'Malacca', 800, 'Regular', [24]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Gulf of Lion', 31), ('France', 31), ('Channel', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 27),
     ('Abyssinian Highlands', 27), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 26), ('Kalinga', 25), ('Doab', 25), ('Bihar', 25), ('Bengal', 25), ('Tibetan Plateau', 25), ('Yunnan', 25), ('Lower Ayeyarwady', 23), ('Malacca Strait', 23), ('Mekong', 25), ('Sunda Strait', 23),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 26), ('Huabei', 26), ('Xibei', 26), ('Eastern Siberia', 27), ('Zhongyuan', 26), ('Nippon', 27),
     ('Amur', 27), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Southeast Asia
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Gulf of Lion', 31), ('France', 31), ('Channel', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ...
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 27),
     ('Abyssinian Highlands', 27), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 26), ('Kalinga', 25), ('Doab', 25), ('Bihar', 25), ('Bengal', 25), ('Tibetan Plateau', 25), ('Yunnan', 25), ('Lower Ayeyarwady', 23), ('Malacca Strait', 23), ('Mekong', 23), ('Sunda Strait', 25),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 26), ('Huabei', 26), ('Xibei', 26), ('Eastern Siberia', 27), ('Zhongyuan', 26), ('Nippon', 27),
     ('Amur', 27), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Indonesia
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Gulf of Lion', 31), ('France', 31), ('Channel', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ...
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 27),
     ('Abyssinian Highlands', 27), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 26), ('Kalinga', 26), ('Doab', 26), ('Bihar', 26), ('Bengal', 26), ('Tibetan Plateau', 26), ('Yunnan', 26), ('Lower Ayeyarwady', 25), ('Malacca Strait', 23), ('Mekong', 25), ('Sunda Strait', 23),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 26), ('Huabei', 26), ('Xibei', 26), ('Eastern Siberia', 27), ('Zhongyuan', 26), ('Nippon', 27),
     ('Amur', 27), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# the Philippines
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Gulf of Lion', 31), ('France', 31), ('Channel', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Lower Nile', 29), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ...
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 27),
     ('Abyssinian Highlands', 27), ('Jazira', 27), ('Arabian Gulf', 27), ('Iran', 27), ('Khorasan', 27), ('Mawarannahr', 27), ('Tarim Basin', 27),
     ('Punjab', 27), ('Gurjaratra', 27), ('Konkan', 27), ('Southern Deccan', 27), ('Tamilakam', 26), ('Kalinga', 26), ('Doab', 26), ('Bihar', 26), ('Bengal', 26), ('Tibetan Plateau', 26), ('Yunnan', 26), ('Lower Ayeyarwady', 25), ('Malacca Strait', 25), ('Mekong', 25), ('Sunda Strait', 25),
     ('Champa Sea', 23), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 26), ('Huabei', 26), ('Xibei', 26), ('Eastern Siberia', 27), ('Zhongyuan', 26), ('Nippon', 27),
     ('Amur', 27), ('Chala', 33), ('Southern Cone', 32), ('Guiana', 31), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 32), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Papua New Guinea
expeditions_list.append(Expedition('papua', 'Papua New Guinea', 100, 'Regular', [2]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 49), ('Strait of Gibraltar', 49), ('Sahara', 49), ('Gulf of Lion', 49), ('France', 49), ('Channel', 49), ('Western Baltic', 49), ('Berber Coast', 49), ('Tyrrenean Sea', 49), ('Rhineland', 49), ('Lower Nile', 49), ('Po Valley', 49), ('Adriatic Sea', 49), ('Levantine Sea', 49),
     ('Aegean Sea', 49), ('Lower Danube', 49), ('Middle Danube', 49), ('Elbe', 49), ('Eastern Baltic', 49),
     ('Vistula', 49), ('Black Sea', 49), ('Western Siberia', 49), ('Dnipro', 49), ('Volga', 49), ('Caspian Sea', 49), ('Zalesye', 49), ('Caucasus', 49), ('Senegambia', 49), ('Upper Niger', 49), ('Guinea Coast', 49), ('Lake Tchad', 49), ('Kongo', 49), ('South Africa', 49), ('Monomotapa', 49), ('Zanj', 49), ('Red Sea', 49),
     ('Abyssinian Highlands', 49), ('Jazira', 49), ('Arabian Gulf', 49), ('Iran', 49), ('Khorasan', 49), ('Mawarannahr', 49), ('Tarim Basin', 49),
     ('Punjab', 49), ('Gurjaratra', 49), ('Konkan', 49), ('Southern Deccan', 49), ('Tamilakam', 49), ('Kalinga', 49), ('Doab', 49), ('Bihar', 49), ('Bengal', 49), ('Tibetan Plateau', 49), ('Yunnan', 49), ('Lower Ayeyarwady', 49), ('Malacca Strait', 49), ('Mekong', 49), ('Sunda Strait', 49),
     ('Champa Sea', 49), ('Australia', 49), ('Liangguang', 49), ('Szechwan', 49), ('Huazhong', 49), ('Jiangxi', 49), ('Jiangnan', 49), ('Huabei', 49), ('Xibei', 49), ('Eastern Siberia', 49), ('Zhongyuan', 49), ('Nippon', 49),
     ('Amur', 49), ('Chala', 49), ('Southern Cone', 49), ('Guiana', 49), ('Amazonia', 49), ('Panama', 49), ('Caribbean', 49), ('Valley of Mexico', 49), ('Rio Grande', 49), ('Mississippi', 49), ('Plains', 49), ('Eastern Seaboard', 49), ('Great Lakes', 49),
     ('American West Coast', 49), ('Pacific', 49)])
# Australia
expeditions_list.append(Expedition('australia', 'Australia', 100, 'Colonial Node', [2]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 48), ('Strait of Gibraltar', 48), ('Sahara', 48), ('Gulf of Lion', 48), ('France', 48), ('Channel', 48), ('Western Baltic', 48), ('Berber Coast', 48), ('Tyrrenean Sea', 48), ('Rhineland', 48), ('Lower Nile', 48), ('Po Valley', 48), ('Adriatic Sea', 48), ('Levantine Sea', 48),
     ('Aegean Sea', 48), ('Lower Danube', 48), ('Middle Danube', 48), ('Elbe', 48), ('Eastern Baltic', 48),
     ('Vistula', 48), ('Black Sea', 48), ('Western Siberia', 48), ('Dnipro', 48), ('Volga', 48), ('Caspian Sea', 48), ('Zalesye', 48), ('Caucasus', 48), ('Senegambia', 48), ('Upper Niger', 48), ('Guinea Coast', 48), ('Lake Tchad', 48), ('Kongo', 48), ('South Africa', 48), ('Monomotapa', 48), ('Zanj', 48), ('Red Sea', 48),
     ('Abyssinian Highlands', 48), ('Jazira', 48), ('Arabian Gulf', 48), ('Iran', 48), ('Khorasan', 48), ('Mawarannahr', 48), ('Tarim Basin', 48),
     ('Punjab', 48), ('Gurjaratra', 48), ('Konkan', 48), ('Southern Deccan', 48), ('Tamilakam', 48), ('Kalinga', 48), ('Doab', 48), ('Bihar', 48), ('Bengal', 48), ('Tibetan Plateau', 48), ('Yunnan', 48), ('Lower Ayeyarwady', 48), ('Malacca Strait', 48), ('Mekong', 48), ('Sunda Strait', 48),
     ('Champa Sea', 48), ('Australia', 25), ('Liangguang', 48), ('Szechwan', 48), ('Huazhong', 48), ('Jiangxi', 48), ('Jiangnan', 48), ('Huabei', 48), ('Xibei', 48), ('Eastern Siberia', 48), ('Zhongyuan', 48), ('Nippon', 48),
     ('Amur', 48), ('Chala', 48), ('Southern Cone', 48), ('Guiana', 48), ('Amazonia', 48), ('Panama', 48), ('Caribbean', 48), ('Valley of Mexico', 48), ('Rio Grande', 48), ('Mississippi', 48), ('Plains', 48), ('Eastern Seaboard', 48), ('Great Lakes', 48),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 43), ('Strait of Gibraltar', 43), ('Sahara', 43), ('Gulf of Lion', 43), ('France', 43), ('Channel', 43), ('Western Baltic', 43), ('Berber Coast', 43), ('Tyrrenean Sea', 43), ('Rhineland', 43), ('Lower Nile', 43), ('Po Valley', 43), ('Adriatic Sea', 43), ('Levantine Sea', 43),
     ('Aegean Sea', 43), ('Lower Danube', 43), ('Middle Danube', 43), ('Elbe', 43), ('Eastern Baltic', 43),
     ('Vistula', 43), ('Black Sea', 43), ('Western Siberia', 43), ('Dnipro', 43), ('Volga', 43), ('Caspian Sea', 43), ('Zalesye', 43), ('Caucasus', 43), ('Senegambia', 43), ('Upper Niger', 43), ('Guinea Coast', 43), ('Lake Tchad', 43), ('Kongo', 43), ('South Africa', 43), ('Monomotapa', 43), ('Zanj', 43), ('Red Sea', 43),
     ('Abyssinian Highlands', 43), ('Jazira', 43), ('Arabian Gulf', 43), ('Iran', 43), ('Khorasan', 43), ('Mawarannahr', 43), ('Tarim Basin', 43),
     ('Punjab', 43), ('Gurjaratra', 43), ('Konkan', 43), ('Southern Deccan', 43), ('Tamilakam', 43), ('Kalinga', 43), ('Doab', 43), ('Bihar', 43), ('Bengal', 43), ('Tibetan Plateau', 43), ('Yunnan', 43), ('Lower Ayeyarwady', 43), ('Malacca Strait', 43), ('Mekong', 43), ('Sunda Strait', 43),
     ('Champa Sea', 43), ('Australia', 43), ('Liangguang', 43), ('Szechwan', 43), ('Huazhong', 43), ('Jiangxi', 43), ('Jiangnan', 43), ('Huabei', 43), ('Xibei', 43), ('Eastern Siberia', 43), ('Zhongyuan', 43), ('Nippon', 43),
     ('Amur', 43), ('Chala', 43), ('Southern Cone', 43), ('Guiana', 43), ('Amazonia', 43), ('Panama', 43), ('Caribbean', 43), ('Valley of Mexico', 43), ('Rio Grande', 43), ('Mississippi', 43), ('Plains', 43), ('Eastern Seaboard', 43), ('Great Lakes', 43),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Gulf of Lion', 32), ('France', 32), ('Channel', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ('Aegean Sea', 32), ('Lower Danube', 32), ('Middle Danube', 32), ('Elbe', 32), ('Eastern Baltic', 32),
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Monomotapa', 31), ('Zanj', 31), ('Red Sea', 29),
     ('Abyssinian Highlands', 29), ('Jazira', 29), ('Arabian Gulf', 29), ('Iran', 29), ('Khorasan', 29), ('Mawarannahr', 29), ('Tarim Basin', 29),
     ('Punjab', 28), ('Gurjaratra', 28), ('Konkan', 28), ('Southern Deccan', 28), ('Tamilakam', 28), ('Kalinga', 28), ('Doab', 28), ('Bihar', 28), ('Bengal', 28), ('Tibetan Plateau', 28), ('Yunnan', 28), ('Lower Ayeyarwady', 26), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 23), ('Szechwan', 23), ('Huazhong', 23), ('Jiangxi', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 25), ('Zhongyuan', 25), ('Eastern Siberia', 25), ('Nippon', 25),
     ('Amur', 26), ('Chala', 33), ('Southern Cone', 33), ('Guiana', 32), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 33), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Northern China
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Gulf of Lion', 32), ('France', 32), ('Channel', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ...
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Monomotapa', 31), ('Zanj', 31), ('Red Sea', 29),
     ('Abyssinian Highlands', 29), ('Jazira', 29), ('Arabian Gulf', 29), ('Iran', 29), ('Khorasan', 29), ('Mawarannahr', 29), ('Tarim Basin', 29),
     ('Punjab', 28), ('Gurjaratra', 28), ('Konkan', 28), ('Southern Deccan', 28), ('Tamilakam', 28), ('Kalinga', 27), ('Doab', 27), ('Bihar', 27), ('Bengal', 27), ('Tibetan Plateau', 27), ('Yunnan', 27), ('Lower Ayeyarwady', 26), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 23), ('Jiangxi', 23), ('Jiangnan', 23), ('Huabei', 23), ('Xibei', 23), ('Zhongyuan', 25), ('Eastern Siberia', 23), ('Nippon', 25),
     ('Amur', 26), ('Chala', 33), ('Southern Cone', 33), ('Guiana', 32), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 33), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Korea
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Gulf of Lion', 32), ('France', 32), ('Channel', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ('Aegean Sea', 32), ('Lower Danube', 32), ('Middle Danube', 32), ('Elbe', 32), ('Eastern Baltic', 32),
     ('Vistula', 32), ('Black Sea', 32), ('Western Siberia', 32), ('Dnipro', 32), ('Volga', 32), ('Caspian Sea', 32), ('Zalesye', 32), ('Caucasus', 32), ('Senegambia', 32), ('Upper Niger', 32), ('Guinea Coast', 32), ('Lake Tchad', 32), ('Kongo', 32), ('South Africa', 31), ('Monomotapa', 31), ('Zanj', 31), ('Red Sea', 30),
     ('Abyssinian Highlands', 30), ('Jazira', 30), ('Arabian Gulf', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Tarim Basin', 30),
     ('Punjab', 29), ('Gurjaratra', 29), ('Konkan', 29), ('Southern Deccan', 29), ('Tamilakam', 29), ('Kalinga', 29), ('Doab', 29), ('Bihar', 29), ('Bengal', 29), ('Tibetan Plateau', 29), ('Yunnan', 29), ('Lower Ayeyarwady', 26), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 25), ('Huabei', 25), ('Xibei', 25), ('Zhongyuan', 23), ('Eastern Siberia', 25), ('Nippon', 25),
     ('Amur', 25), ('Chala', 33), ('Southern Cone', 33), ('Guiana', 32), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 33), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
# Japan
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 32), ('Strait of Gibraltar', 32), ('Sahara', 32), ('Gulf of Lion', 32), ('France', 32), ('Channel', 32), ('Western Baltic', 32), ('Berber Coast', 32), ('Tyrrenean Sea', 32), ('Rhineland', 32), ('Lower Nile', 30), ('Po Valley', 32), ('Adriatic Sea', 32), ('Levantine Sea', 32),
     ...
     ('Abyssinian Highlands', 30), ('Jazira', 30), ('Arabian Gulf', 30), ('Iran', 30), ('Khorasan', 30), ('Mawarannahr', 30), ('Tarim Basin', 30),
     ('Punjab', 29), ('Gurjaratra', 29), ('Konkan', 29), ('Southern Deccan', 29), ('Tamilakam', 29), ('Kalinga', 29), ('Doab', 29), ('Bihar', 29), ('Bengal', 29), ('Tibetan Plateau', 29), ('Yunnan', 29), ('Lower Ayeyarwady', 26), ('Malacca Strait', 26), ('Mekong', 26), ('Sunda Strait', 26),
     ('Champa Sea', 25), ('Australia', 27), ('Liangguang', 25), ('Szechwan', 25), ('Huazhong', 25), ('Jiangxi', 25), ('Jiangnan', 25), ('Huabei', 25), ('Xibei', 25), ('Zhongyuan', 25), ('Eastern Siberia', 25), ('Nippon', 23),
     ('Amur', 25), ('Chala', 33), ('Southern Cone', 33), ('Guiana', 32), ('Amazonia', 33), ('Panama', 33), ('Caribbean', 33), ('Valley of Mexico', 33), ('Rio Grande', 33), ('Mississippi', 33), ('Plains', 33), ('Eastern Seaboard', 33), ('Great Lakes', 33),
     ('American West Coast', 33), ('Pacific', 43)])
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Gulf of Lion', 29), ('France', 29), ('Channel', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 32), ('Caspian Sea', 32), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 29), ('Upper Niger', 29), ('Guinea Coast', 29), ('Lake Tchad', 29), ('Kongo', 29), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 31),
     ('Abyssinian Highlands', 31), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 29), ('Panama', 25), ('Caribbean', 23), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 25), ('Plains', 25), ('Eastern Seaboard', 25), ('Great Lakes', 27),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Gulf of Lion', 29), ('France', 29), ('Channel', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 29), ('Upper Niger', 29), ('Guinea Coast', 29), ('Lake Tchad', 29), ('Kongo', 29), ('South Africa', 30), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 31),
     ('Abyssinian Highlands', 31), ('Jazira', 32), ('Arabian Gulf', 32), ('Iran', 32), ('Khorasan', 32), ('Mawarannahr', 32), ('Tarim Basin', 32),
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 29), ('Panama', 25), ('Caribbean', 23), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 25), ('Plains', 25), ('Eastern Seaboard', 25), ('Great Lakes', 27),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 29), ('Strait of Gibraltar', 29), ('Sahara', 29), ('Gulf of Lion', 29), ('France', 29), ('Channel', 29), ('Western Baltic', 29), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ...
     ('Punjab', 32), ('Gurjaratra', 32), ('Konkan', 32), ('Southern Deccan', 32), ('Tamilakam', 32), ('Kalinga', 32), ('Doab', 32), ('Bihar', 32), ('Bengal', 32), ('Tibetan Plateau', 32), ('Yunnan', 32), ('Lower Ayeyarwady', 32), ('Malacca Strait', 32), ('Mekong', 32), ('Sunda Strait', 32),
     ('Champa Sea', 32), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 28), ('Panama', 25), ('Caribbean', 23), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 25), ('Plains', 25), ('Eastern Seaboard', 25), ('Great Lakes', 27),
     ('American West Coast', 30), ('Pacific', 43)])
# Atlantic Colombia
expeditions_list.append(Expedition('atlantic_colombia', 'Atlantic Colombia', 300, 'Colonial Node', [46]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 30), ('South Africa', 31), ('Monomotapa', 31), ('Zanj', 31), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 29), ('Southern Cone', 26), ('Guiana', 25), ('Amazonia', 29), ('Panama', 23), ('Caribbean', 25), ('Valley of Mexico', 26), ('Rio Grande', 26), ('Mississippi', 26), ('Plains', 26), ('Eastern Seaboard', 26), ('Great Lakes', 27),
     ('American West Coast', 30), ('Pacific', 43)])
# Guyana
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ...
     ('Amur', 33), ('Chala', 29), ('Southern Cone', 26), ('Guiana', 25), ('Amazonia', 29), ('Panama', 23), ('Caribbean', 25), ('Valley of Mexico', 26), ('Rio Grande', 26), ('Mississippi', 26), ('Plains', 26), ('Eastern Seaboard', 26), ('Great Lakes', 27),
     ('American West Coast', 30), ('Pacific', 43)])
# Atlantic Valley of Mexico
expeditions_list.append(Expedition('atlantic_Valley of Mexico', 'Atlantic Valley of Mexico', 1600, 'Colonial Node', [45, 9]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 31), ('Strait of Gibraltar', 31), ('Sahara', 31), ('Gulf of Lion', 31), ('France', 31), ('Channel', 31), ('Western Baltic', 31), ('Berber Coast', 31), ('Tyrrenean Sea', 31), ('Rhineland', 31), ('Lower Nile', 31), ('Po Valley', 31), ('Adriatic Sea', 31), ('Levantine Sea', 31),
     ('Aegean Sea', 31), ('Lower Danube', 31), ('Middle Danube', 31), ('Elbe', 31), ('Eastern Baltic', 31),
     ('Vistula', 31), ('Black Sea', 31), ('Western Siberia', 31), ('Dnipro', 31), ('Volga', 31), ('Caspian Sea', 31), ('Zalesye', 31), ('Caucasus', 31), ('Senegambia', 31), ('Upper Niger', 31), ('Guinea Coast', 31), ('Lake Tchad', 31), ('Kongo', 31), ('South Africa', 31), ('Monomotapa', 31), ('Zanj', 31), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 29), ('Panama', 23), ('Caribbean', 25), ('Valley of Mexico', 23), ('Rio Grande', 23), ('Mississippi', 25), ('Plains', 25), ('Eastern Seaboard', 26), ('Great Lakes', 27),
     ('American West Coast', 30), ('Pacific', 43)])
# Northern Brazil
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ('Aegean Sea', 30), ('Lower Danube', 30), ('Middle Danube', 30), ('Elbe', 30), ('Eastern Baltic', 30),
     ('Vistula', 30), ('Black Sea', 30), ('Western Siberia', 30), ('Dnipro', 30), ('Volga', 30), ('Caspian Sea', 30), ('Zalesye', 30), ('Caucasus', 30), ('Senegambia', 27), ('Upper Niger', 27), ('Guinea Coast', 27), ('Lake Tchad', 27), ('Kongo', 28), ('South Africa', 29), ('Monomotapa', 30), ('Zanj', 30), ('Red Sea', 30),
     ('Abyssinian Highlands', 30), ('Jazira', 31), ('Arabian Gulf', 31), ('Iran', 31), ('Khorasan', 31), ('Mawarannahr', 31), ('Tarim Basin', 31),
     ('Punjab', 31), ('Gurjaratra', 31), ('Konkan', 31), ('Southern Deccan', 31), ('Tamilakam', 31), ('Kalinga', 31), ('Doab', 31), ('Bihar', 31), ('Bengal', 31), ('Tibetan Plateau', 31), ('Yunnan', 31), ('Lower Ayeyarwady', 31), ('Malacca Strait', 31), ('Mekong', 31), ('Sunda Strait', 31),
     ('Champa Sea', 31), ('Australia', 32), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 27), ('Southern Cone', 23), ('Guiana', 23), ('Amazonia', 27), ('Panama', 26), ('Caribbean', 25), ('Valley of Mexico', 26), ('Rio Grande', 26), ('Mississippi', 26), ('Plains', 26), ('Eastern Seaboard', 26), ('Great Lakes', 27),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 30), ('Strait of Gibraltar', 30), ('Sahara', 30), ('Gulf of Lion', 30), ('France', 30), ('Channel', 30), ('Western Baltic', 30), ('Berber Coast', 30), ('Tyrrenean Sea', 30), ('Rhineland', 30), ('Lower Nile', 30), ('Po Valley', 30), ('Adriatic Sea', 30), ('Levantine Sea', 30),
     ...
     ('Amur', 32), ('Chala', 27), ('Southern Cone', 23), ('Guiana', 23), ('Amazonia', 27), ('Panama', 26), ('Caribbean', 25), ('Valley of Mexico', 26), ('Rio Grande', 26), ('Mississippi', 26), ('Plains', 26), ('Eastern Seaboard', 26), ('Great Lakes', 27),
     ('American West Coast', 29), ('Pacific', 43)])
# the Gulf of Valley of Mexico
expeditions_list.append(Expedition('gulf_of_Valley of Mexico', 'the Gulf of Valley of Mexico', 200, 'Colonial Node', [65, 66]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Gulf of Lion', 35), ('France', 35), ('Channel', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ('Aegean Sea', 35), ('Lower Danube', 35), ('Middle Danube', 35), ('Elbe', 35), ('Eastern Baltic', 35),
     ('Vistula', 35), ('Black Sea', 35), ('Western Siberia', 35), ('Dnipro', 35), ('Volga', 35), ('Caspian Sea', 35), ('Zalesye', 35), ('Caucasus', 35), ('Senegambia', 35), ('Upper Niger', 35), ('Guinea Coast', 35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Monomotapa', 35), ('Zanj', 35), ('Red Sea', 35),
     ('Abyssinian Highlands', 35), ('Jazira', 35), ('Arabian Gulf', 35), ('Iran', 35), ('Khorasan', 35), ('Mawarannahr', 35), ('Tarim Basin', 35),
     ('Punjab', 35), ('Gurjaratra', 35), ('Konkan', 35), ('Southern Deccan', 35), ('Tamilakam', 35), ('Kalinga', 35), ('Doab', 35), ('Bihar', 35), ('Bengal', 35), ('Tibetan Plateau', 35), ('Yunnan', 35), ('Lower Ayeyarwady', 35), ('Malacca Strait', 35), ('Mekong', 35), ('Sunda Strait', 35),
     ('Champa Sea', 35), ('Australia', 35), ('Liangguang', 35), ('Szechwan', 35), ('Huazhong', 35), ('Jiangxi', 35), ('Jiangnan', 35), ('Huabei', 35), ('Xibei', 35), ('Zhongyuan', 35), ('Eastern Siberia', 35), ('Nippon', 35),
     ('Amur', 35), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 29), ('Panama', 25), ('Caribbean', 25), ('Valley of Mexico', 25), ('Rio Grande', 23), ('Mississippi', 23), ('Plains', 23), ('Eastern Seaboard', 25), ('Great Lakes', 27),
     ('American West Coast', 30), ('Pacific', 43)])
# Southeastern America
expeditions_list.append(Expedition('southeastern_america', 'Southeastern America', 400, 'Colonial Node', [69, 66]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Gulf of Lion', 33), ('France', 33), ('Channel', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast', 33), ('Lake Tchad', 33), ('Kongo', 33), ('South Africa', 33), ('Monomotapa', 33), ('Zanj', 33), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 29), ('Southern Cone', 27), ('Guiana', 26), ('Amazonia', 29), ('Panama', 26), ('Caribbean', 25), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 23), ('Plains', 23), ('Eastern Seaboard', 23), ('Great Lakes', 25),
     ('American West Coast', 30), ('Pacific', 43)])
# Eastern America
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Gulf of Lion', 35), ('France', 35), ('Channel', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ...
     ('Punjab', 35), ('Gurjaratra', 35), ('Konkan', 35), ('Southern Deccan', 35), ('Tamilakam', 35), ('Kalinga', 35), ('Doab', 35), ('Bihar', 35), ('Bengal', 35), ('Tibetan Plateau', 35), ('Yunnan', 35), ('Lower Ayeyarwady', 35), ('Malacca Strait', 35), ('Mekong', 35), ('Sunda Strait', 35),
     ('Champa Sea', 35), ('Australia', 35), ('Liangguang', 35), ('Szechwan', 35), ('Huazhong', 35), ('Jiangxi', 35), ('Jiangnan', 35), ('Huabei', 35), ('Xibei', 35), ('Zhongyuan', 35), ('Eastern Siberia', 35), ('Nippon', 35),
     ('Amur', 35), ('Chala', 30), ('Southern Cone', 29), ('Guiana', 29), ('Amazonia', 30), ('Panama', 26), ('Caribbean', 26), ('Valley of Mexico', 26), ('Rio Grande', 26), ('Mississippi', 26), ('Plains', 26), ('Eastern Seaboard', 23), ('Great Lakes', 25),
     ('American West Coast', 31), ('Pacific', 43)])
# Great Lakes
expeditions_list.append(Expedition('Great Lakes', 'Great Lakes', 200, 'Colonial Node', [67]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 35), ('Strait of Gibraltar', 35), ('Sahara', 35), ('Gulf of Lion', 35), ('France', 35), ('Channel', 35), ('Western Baltic', 35), ('Berber Coast', 35), ('Tyrrenean Sea', 35), ('Rhineland', 35), ('Lower Nile', 35), ('Po Valley', 35), ('Adriatic Sea', 35), ('Levantine Sea', 35),
     ('Aegean Sea', 35), ('Lower Danube', 35), ('Middle Danube', 35), ('Elbe', 35), ('Eastern Baltic', 35),
     ('Vistula', 35), ('Black Sea', 35), ('Western Siberia', 35), ('Dnipro', 35), ('Volga', 35), ('Caspian Sea', 35), ('Zalesye', 35), ('Caucasus', 35), ('Senegambia', 35), ('Upper Niger', 35), ('Guinea Coast', 35), ('Lake Tchad', 35), ('Kongo', 35), ('South Africa', 35), ('Monomotapa', 35), ('Zanj', 35), ('Red Sea', 35),
     ...
     ('Punjab', 35), ('Gurjaratra', 35), ('Konkan', 35), ('Southern Deccan', 35), ('Tamilakam', 35), ('Kalinga', 35), ('Doab', 35), ('Bihar', 35), ('Bengal', 35), ('Tibetan Plateau', 35), ('Yunnan', 35), ('Lower Ayeyarwady', 35), ('Malacca Strait', 35), ('Mekong', 35), ('Sunda Strait', 35),
     ('Champa Sea', 35), ('Australia', 35), ('Liangguang', 35), ('Szechwan', 35), ('Huazhong', 35), ('Jiangxi', 35), ('Jiangnan', 35), ('Huabei', 35), ('Xibei', 35), ('Zhongyuan', 35), ('Eastern Siberia', 35), ('Nippon', 35),
     ('Amur', 35), ('Chala', 35), ('Southern Cone', 35), ('Guiana', 35), ('Amazonia', 35), ('Panama', 35), ('Caribbean', 35), ('Valley of Mexico', 35), ('Rio Grande', 35), ('Mississippi', 35), ('Plains', 35), ('Eastern Seaboard', 25), ('Great Lakes', 23),
     ('American West Coast', 35), ('Pacific', 43)])
# the North Atlantic
expeditions_list.append(Expedition('north_atlantic', 'the North Atlantic', 50, 'Jumping Node', [85]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 40), ('Strait of Gibraltar', 40), ('Sahara', 40), ('Gulf of Lion', 40), ('France', 40), ('Channel', 40), ('Western Baltic', 40), ('Berber Coast', 40), ('Tyrrenean Sea', 40), ('Rhineland', 40), ('Lower Nile', 40), ('Po Valley', 40), ('Adriatic Sea', 40), ('Levantine Sea', 40),
     ('Aegean Sea', 40), ('Lower Danube', 40), ('Middle Danube', 40), ('Elbe', 40), ('Eastern Baltic', 40),
     ('Vistula', 40), ('Black Sea', 40), ('Western Siberia', 40), ('Dnipro', 40), ('Volga', 40), ('Caspian Sea', 40), ('Zalesye', 40), ('Caucasus', 40), ('Senegambia', 40), ('Upper Niger', 40), ('Guinea Coast', 40), ('Lake Tchad', 40), ('Kongo', 40), ('South Africa', 40), ('Monomotapa', 40), ('Zanj', 40), ('Red Sea', 40),
     ('Abyssinian Highlands', 40), ('Jazira', 40), ('Arabian Gulf', 40), ('Iran', 40), ('Khorasan', 40), ('Mawarannahr', 40), ('Tarim Basin', 40),
     ('Punjab', 40), ('Gurjaratra', 40), ('Konkan', 40), ('Southern Deccan', 40), ('Tamilakam', 40), ('Kalinga', 40), ('Doab', 40), ('Bihar', 40), ('Bengal', 40), ('Tibetan Plateau', 40), ('Yunnan', 40), ('Lower Ayeyarwady', 40), ('Malacca Strait', 40), ('Mekong', 40), ('Sunda Strait', 40),
     ('Champa Sea', 40), ('Australia', 40), ('Liangguang', 40), ('Szechwan', 40), ('Huazhong', 40), ('Jiangxi', 40), ('Jiangnan', 40), ('Huabei', 40), ('Xibei', 40), ('Zhongyuan', 40), ('Eastern Siberia', 40), ('Nippon', 40),
     ('Amur', 40), ('Chala', 40), ('Southern Cone', 40), ('Guiana', 40), ('Amazonia', 40), ('Panama', 40), ('Caribbean', 40), ('Valley of Mexico', 40), ('Rio Grande', 40), ('Mississippi', 40), ('Plains', 40), ('Eastern Seaboard', 40), ('Great Lakes', 40),
     ('American West Coast', 40), ('Pacific', 43)])
# Hudson Bay
expeditions_list.append(Expedition('hudson_bay', 'Hudson Bay', 100, 'Colonial Node', [67]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 45), ('Strait of Gibraltar', 45), ('Sahara', 45), ('Gulf of Lion', 45), ('France', 45), ('Channel', 45), ('Western Baltic', 45), ('Berber Coast', 45), ('Tyrrenean Sea', 45), ('Rhineland', 45), ('Lower Nile', 45), ('Po Valley', 45), ('Adriatic Sea', 45), ('Levantine Sea', 45),
     ('Aegean Sea', 45), ('Lower Danube', 45), ('Middle Danube', 45), ('Elbe', 45), ('Eastern Baltic', 45),
     ('Vistula', 45), ('Black Sea', 45), ('Western Siberia', 45), ('Dnipro', 45), ('Volga', 45), ('Caspian Sea', 45), ('Zalesye', 45), ('Caucasus', 45), ('Senegambia', 45), ('Upper Niger', 45), ('Guinea Coast', 45), ('Lake Tchad', 45), ('Kongo', 45), ('South Africa', 45), ('Monomotapa', 45), ('Zanj', 45), ('Red Sea', 45),
     ('Abyssinian Highlands', 45), ('Jazira', 45), ('Arabian Gulf', 45), ('Iran', 45), ('Khorasan', 45), ('Mawarannahr', 45), ('Tarim Basin', 45),
     ('Punjab', 45), ('Gurjaratra', 45), ('Konkan', 45), ('Southern Deccan', 45), ('Tamilakam', 45), ('Kalinga', 45), ('Doab', 45), ('Bihar', 45), ('Bengal', 45), ('Tibetan Plateau', 45), ('Yunnan', 45), ('Lower Ayeyarwady', 45), ('Malacca Strait', 45), ('Mekong', 45), ('Sunda Strait', 45),
     ('Champa Sea', 45), ('Australia', 45), ('Liangguang', 45), ('Szechwan', 45), ('Huazhong', 45), ('Jiangxi', 45), ('Jiangnan', 45), ('Huabei', 45), ('Xibei', 45), ('Zhongyuan', 45), ('Eastern Siberia', 45), ('Nippon', 45),
     ('Amur', 45), ('Chala', 45), ('Southern Cone', 45), ('Guiana', 45), ('Amazonia', 45), ('Panama', 45), ('Caribbean', 45), ('Valley of Mexico', 45), ('Rio Grande', 45), ('Mississippi', 45), ('Plains', 45), ('Eastern Seaboard', 45), ('Great Lakes', 23),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Gulf of Lion', 33), ('France', 33), ('Channel', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33),
     ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Senegambia', 30), ('Upper Niger', 30), ('Guinea Coast', 30), ('Lake Tchad', 30), ('Kongo', 31), ('South Africa', 33), ('Monomotapa', 33), ('Zanj', 33), ('Red Sea', 33),
     ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 26), ('Southern Cone', 23), ('Guiana', 25), ('Amazonia', 26), ('Panama', 27), ('Caribbean', 27), ('Valley of Mexico', 27), ('Rio Grande', 27), ('Mississippi', 27), ('Plains', 27), ('Eastern Seaboard', 27), ('Great Lakes', 29),
     ('American West Coast', 29), ('Pacific', 43)])
# California
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 40), ('Strait of Gibraltar', 40), ('Sahara', 40), ('Gulf of Lion', 40), ('France', 40), ('Channel', 40), ('Western Baltic', 40), ('Berber Coast', 40), ('Tyrrenean Sea', 40), ('Rhineland', 40), ('Lower Nile', 40), ('Po Valley', 40), ('Adriatic Sea', 40), ('Levantine Sea', 40),
     ('Aegean Sea', 40), ('Lower Danube', 40), ('Middle Danube', 40), ('Elbe', 40), ('Eastern Baltic', 40),
     ('Vistula', 40), ('Black Sea', 40), ('Western Siberia', 40), ('Dnipro', 40), ('Volga', 40), ('Caspian Sea', 40), ('Zalesye', 40), ('Caucasus', 40), ('Senegambia', 40), ('Upper Niger', 40), ('Guinea Coast', 40), ('Lake Tchad', 40), ('Kongo', 40), ('South Africa', 40), ('Monomotapa', 40), ('Zanj', 40), ('Red Sea', 35),
     ('Abyssinian Highlands', 35), ('Jazira', 35), ('Arabian Gulf', 35), ('Iran', 35), ('Khorasan', 35), ('Mawarannahr', 35), ('Tarim Basin', 35),
     ('Punjab', 35), ('Gurjaratra', 35), ('Konkan', 35), ('Southern Deccan', 35), ('Tamilakam', 35), ('Kalinga', 35), ('Doab', 35), ('Bihar', 35), ('Bengal', 35), ('Tibetan Plateau', 35), ('Yunnan', 35), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 31), ('Szechwan', 31), ('Huazhong', 31), ('Jiangxi', 31), ('Jiangnan', 31), ('Huabei', 31), ('Xibei', 31), ('Zhongyuan', 30), ('Eastern Siberia', 30), ('Nippon', 30),
     ('Amur', 30), ('Chala', 27), ('Southern Cone', 29), ('Guiana', 29), ('Amazonia', 27), ('Panama', 26), ('Caribbean', 29), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 29), ('Plains', 29), ('Eastern Seaboard', 29), ('Great Lakes', 30),
     ('American West Coast', 23), ('Pacific', 43)])
# Alaska
expeditions_list.append(Expedition('alaska', 'Alaska', 100, 'Colonial Node', [8]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 47), ('Strait of Gibraltar', 47), ('Sahara', 47), ('Gulf of Lion', 47), ('France', 47), ('Channel', 47), ('Western Baltic', 47), ('Berber Coast', 47), ('Tyrrenean Sea', 47), ('Rhineland', 47), ('Lower Nile', 47), ('Po Valley', 47), ('Adriatic Sea', 47), ('Levantine Sea', 47),
     ('Aegean Sea', 47), ('Lower Danube', 47), ('Middle Danube', 47), ('Elbe', 47), ('Eastern Baltic', 47),
     ('Vistula', 47), ('Black Sea', 47), ('Western Siberia', 47), ('Dnipro', 47), ('Volga', 47), ('Caspian Sea', 47), ('Zalesye', 47), ('Caucasus', 47), ('Senegambia', 47), ('Upper Niger', 47), ('Guinea Coast', 47), ('Lake Tchad', 47), ('Kongo', 47), ('South Africa', 47), ('Monomotapa', 47), ('Zanj', 47), ('Red Sea', 47),
     ('Abyssinian Highlands', 47), ('Jazira', 47), ('Arabian Gulf', 47), ('Iran', 47), ('Khorasan', 47), ('Mawarannahr', 47), ('Tarim Basin', 47),
     ('Punjab', 47), ('Gurjaratra', 47), ('Konkan', 47), ('Southern Deccan', 47), ('Tamilakam', 47), ('Kalinga', 47), ('Doab', 47), ('Bihar', 47), ('Bengal', 47), ('Tibetan Plateau', 47), ('Yunnan', 47), ('Lower Ayeyarwady', 47), ('Malacca Strait', 47), ('Mekong', 47), ('Sunda Strait', 47),
     ('Champa Sea', 47), ('Australia', 47), ('Liangguang', 47), ('Szechwan', 47), ('Huazhong', 47), ('Jiangxi', 47), ('Jiangnan', 47), ('Huabei', 47), ('Xibei', 47), ('Zhongyuan', 47), ('Eastern Siberia', 40), ('Nippon', 40),
     ('Amur', 40), ('Chala', 40), ('Southern Cone', 40), ('Guiana', 40), ('Amazonia', 40), ('Panama', 40), ('Caribbean', 40), ('Valley of Mexico', 40), ('Rio Grande', 40), ('Mississippi', 40), ('Plains', 40), ('Eastern Seaboard', 40), ('Great Lakes', 35),
     ('American West Coast', 23), ('Pacific', 43)])
# Pacific Valley of Mexico
expeditions_list.append(Expedition('pacific_Valley of Mexico', 'Pacific Valley of Mexico', 800, 'Colonial Node', [9, 65]))
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Gulf of Lion', 33), ('France', 33), ('Channel', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ('Aegean Sea', 33), ('Lower Danube', 33), ('Middle Danube', 33), ('Elbe', 33), ('Eastern Baltic', 33), ('Vistula', 33), ('Black Sea', 33), ('Western Siberia', 33), ('Dnipro', 33), ('Volga', 33), ('Caspian Sea', 33), ('Zalesye', 33), ('Caucasus', 33), ('Senegambia', 33), ('Upper Niger', 33), ('Guinea Coast', 33), ('Lake Tchad', 33), ('Kongo', 33),
     ('South Africa', 33), ('Monomotapa', 33), ('Zanj', 33), ('Red Sea', 33), ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 32), ('Szechwan', 32), ('Huazhong', 32), ('Jiangxi', 32), ('Jiangnan', 32), ('Huabei', 32), ('Xibei', 32), ('Zhongyuan', 31), ('Eastern Siberia', 31), ('Nippon', 31),
     ('Amur', 31), ('Chala', 26), ('Southern Cone', 27), ('Guiana', 27), ('Amazonia', 26), ('Panama', 25), ('Caribbean', 29), ('Valley of Mexico', 25), ('Rio Grande', 23), ('Mississippi', 29), ('Plains', 29), ('Eastern Seaboard', 29), ('Great Lakes', 30),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Gulf of Lion', 33), ('France', 33), ('Channel', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ...
     ('Abyssinian Highlands', 33), ('Jazira', 33), ('Arabian Gulf', 33), ('Iran', 33), ('Khorasan', 33), ('Mawarannahr', 33), ('Tarim Basin', 33),
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 32), ('Eastern Siberia', 32), ('Nippon', 32),
     ('Amur', 32), ('Chala', 25), ('Southern Cone', 27), ('Guiana', 27), ('Amazonia', 25), ('Panama', 23), ('Caribbean', 29), ('Valley of Mexico', 25), ('Rio Grande', 25), ('Mississippi', 29), ('Plains', 29), ('Eastern Seaboard', 29), ('Great Lakes', 30),
...
expeditions_list[-1].set_node_tech_reqs(
    [('Iberia', 33), ('Strait of Gibraltar', 33), ('Sahara', 33), ('Gulf of Lion', 33), ('France', 33), ('Channel', 33), ('Western Baltic', 33), ('Berber Coast', 33), ('Tyrrenean Sea', 33), ('Rhineland', 33), ('Lower Nile', 33), ('Po Valley', 33), ('Adriatic Sea', 33), ('Levantine Sea', 33),
     ...
     ('Punjab', 33), ('Gurjaratra', 33), ('Konkan', 33), ('Southern Deccan', 33), ('Tamilakam', 33), ('Kalinga', 33), ('Doab', 33), ('Bihar', 33), ('Bengal', 33), ('Tibetan Plateau', 33), ('Yunnan', 33), ('Lower Ayeyarwady', 33), ('Malacca Strait', 33), ('Mekong', 33), ('Sunda Strait', 33),
     ('Champa Sea', 33), ('Australia', 33), ('Liangguang', 33), ('Szechwan', 33), ('Huazhong', 33), ('Jiangxi', 33), ('Jiangnan', 33), ('Huabei', 33), ('Xibei', 33), ('Zhongyuan', 33), ('Eastern Siberia', 33), ('Nippon', 33),
     ('Amur', 33), ('Chala', 23), ('Southern Cone', 26), ('Guiana', 27), ('Amazonia', 23), ('Panama', 26), ('Caribbean', 29), ('Valley of Mexico', 26), ('Rio Grande', 27), ('Mississippi', 29), ('Plains', 29), ('Eastern Seaboard', 29), ('Great Lakes', 30),
...
trade_nodes = {'Pacific': 1, 'Australia': 2, 'Huai He': 3, 'Zhongyuan': 4, 'Jiangnan': 5, 'East Sea': 6, 'Amur': 7, 'Yellow Sea': 8, 'Nippon': 9, 'Jiangxi': 10, 
               ...
               'Abyssinian Highlands': 59, 'Upper Nile': 60, 'Iran': 61, 'Arabian Peninsula': 62, 'Arabian Gulf': 63, 'Red Sea': 64, 'Great Lakes': 65, 'Monomotapa': 66, 
               ...
               'Levantine Sea': 94, 'Zalesye': 95, 'Vistula': 96, 'Rockies': 97, 'Plains': 98, 'Rio Grande': 99, 'Mississippi': 100, 'Great Lakes': 101, 'Caribbean': 102, 
...
can_trigger_MAM_event_15 = ['east_africa', 'indian_ocean', 'Arabian Gulf', 'indian_ocean', 'western_india', 'southern_india']
