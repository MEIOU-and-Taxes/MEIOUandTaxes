...
NDiplomacy = {
	...
	INCREASE_TRUST_COST = 25,						-- Cost in favors to increase trust
	...
	CALL_TO_ARMS_COST = 30,							-- Cost in favors to call ally to arms when you're not promising them territory
	...
	HRE_PRINCE_AUTHORITY_THRESHOLD = 70,  -- Threshold below which you lose IA and above which you gain it
	...
	FABRICATE_CLAIM_COST = 50,  
	FABRICATE_CLAIM_COST_MODIFIER_PER_CLAIM = 0.20,
...
NCountry = {
	...
	MIN_TECH_FOR_CIRCUMNAVIGATE = 30,  -- Must have this level of dip tech to circumnavigate the globe
	...
	PS_REDUCE_INFLATION = 99999, -- Disabled done through policy
	...
	LIBERTY_DESIRE_DIPLO_TECH = 10,  -- Liberty desire per point of diplo tech more than overlord
	...
	INNOVATIVENESS_FIRST_REACHED_TECH_LEVEL = 6.0,  -- Innovativeness bonus to first country (or countries) to reach a certain tech level.
	INNOVATIVENESS_FIRST_PICKED_IDEA = 4.0,			-- Innovativeness bonus to first country (or countries) to pick an idea.
...
NEconomy = {
	...
	NAVAL_TECH_MAINTENANCE_IMPACT = 0, 			-- % each tech increases it. # Beors - changed from 0.02 --> already included in internal systems
	...
	TRADED_FRACTION_FOR_BONUS = 9999.00,  -- 99999% required trade control of a trade good makes it impossible to obtain the "Trading in <trade good>" bonus.
...
NAI = {
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 120, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	...
	AI_FORT_PER_DEV_RATIO = 100, -- How much development the AI wants per fort (approximately)
	FORT_ON_BORDER_MULT = 0.75, -- 
	FORT_NEXT_TO_FORT_MULT = 0.50, -- 
	...
	TRANSPORT_FRACTION = 0.33,  -- Max fraction of naval forcelimit that should be transports
	...
	ADVISOR_BUDGET_FRACTION_MIN = 0.25,  -- AI will spend a minimum of this fraction of monthly income on advisor maintenance    #Vanilla is 0.15
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MAX = 0.40,  -- If the AI has meritocracy enabled #Vanilla is 0.5, set as no impact
	ADVISOR_BUDGET_FRACTION_MERITOCRACY_MIN = 0.25,  -- If the AI has meritocracy enabled #Vanilla is 0.25, set as no impact
	...
	CORRUPTION_BUDGET_FRACTION = 0.05,  -- AI will spend a maximum of this fraction of monthly income on rooting out corruption
	...
	REGIMENTS_PER_GENERAL = 10,  -- AI will want one general for every this number of regiments (will not exceed free leader pool)
	...
	PEACE_MANDATE_THREAT_FACTOR = 2,  -- Modifies how much AI wants peace based on threat to celestial empire mandate.
	...
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.25, --releasing vassals should be less desired from transferring them
	...
	PEACE_TERMS_PROVINCE_NOT_ADJACENT_MULT = 0.25,  -- AI desire for a province is multiplied by this if it is not adjacent at all (including vassals and other provinces being taken in peace)
	...
	PEACE_TERMS_RETURN_CORES_NOT_FRIEND_MULT = 0.2,  -- AI desire for returning core provinces is multiplied by this if they are not friends of the country core is being returned to
	...
	PEACE_TERMS_RELEASE_VASSAL_HRE_MULT = 5.0,  -- AI desire for releasing a vassal is multiplied by this if both are HRE member
	...
	DIPLOMATIC_ACTION_GUARANTEE_PROTECT_FACTOR = 100, -- AI scoring for guarantee is changed by this if they have an attitude with the 'protect' desire
	...
	MISSIONARY_MAINTENANCE_SHARE = 0.25,							-- The most an AI will spend of its income on a missionary
